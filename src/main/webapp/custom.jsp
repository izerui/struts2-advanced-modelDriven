        ...
        <form class="form-horizontal" >
            <fieldset>
                <div class="control-group">
                    <label class="control-label" >ID (po)</label>
                    <div class="controls">
                        ${formParam.po.id}
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">名字 (po)</label>
                    <div class="controls">
                        ${formParam.po.name}
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" >头像 (po)</label>
                    <div class="controls">
                        ${formParam.po.pic.path}
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" >个人说明 (po)</label>
                    <div class="controls">
                        ${formParam.po.memo}
                    </div>
                </div>
