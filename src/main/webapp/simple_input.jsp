...
<html>
  ...
  <div class="container">
      ...
      <div class="row-fluid">
          <form class="form-horizontal" action="simple!simple.action" method="post"  enctype="multipart/form-data">
              <fieldset>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                          <input type="text" class="span3" id="name" name="name" placeholder="请输入你的名字" required="true">
                      </div>
                  </div>
                  <div class="control-group">
                      <label class="control-label" for="pic">头像</label>
                      <div class="controls">
                          <input id="pic" class="span8" name="pic" type="file" required="true">
                      </div>
                  </div>
                  <div class="control-group">
                      <label class="control-label" for="memo">个人说明</label>
                      <div class="controls">
                          <textarea class="input-xlarge" id="memo" name="memo" rows="3" placeholder="个人说明" required="true"></textarea>
                      </div>
                  </div>
